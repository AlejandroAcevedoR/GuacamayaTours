...
function ngbAutoClose(zone, document, type, close, closed$, insideElements, ignoreElements, insideSelector) {
    ...
    if (type) {
        ...
        () => {
            ...
            /** @type {?} */
            const escapes$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(document, 'keyup')
...
class NgbModalWindow {
    ...
    constructor(_document, _elRef, zone) {
         ...
         */
        () => {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this._elRef.nativeElement, 'keyup')
...
let AcordionEstadosComponent = class AcordionEstadosComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
const routes = [{ path: '', component: _destinos_component__WEBPACK_IMPORTED_MODULE_3__["DestinosComponent"] }];
let DestinosRoutingModule = class DestinosRoutingModule {
};
