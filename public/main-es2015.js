...
const routes = [
    ...
    { path: 'main', loadChildren: () => __webpack_require__.e(/*! import() | navigation-main-main-module */ "navigation-main-main-module").then(__webpack_require__.bind(null, /*! ./navigation/main/main.module */ "./src/app/navigation/main/main.module.ts"))
            .then(m => m.MainModule) },
    { path: 'admin', loadChildren: () => Promise.all(/*! import() | navigation-admin-admin-module */[__webpack_require__.e("default~modules-hoteles-hoteles-module~navigation-admin-admin-module"), __webpack_require__.e("navigation-admin-admin-module")]).then(__webpack_require__.bind(null, /*! ./navigation/admin/admin.module */ "./src/app/navigation/admin/admin.module.ts"))
...
const firebaseConfig = _environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].firebaseConfig;
const config = {
