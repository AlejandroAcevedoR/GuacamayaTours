...
const routes = [{ path: '', component: _itinerario_component__WEBPACK_IMPORTED_MODULE_3__["ItinerarioComponent"] }];
let ItinerarioRoutingModule = class ItinerarioRoutingModule {
};
...
let ItinerarioComponent = class ItinerarioComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ItinerarioModule = class ItinerarioModule {
};
