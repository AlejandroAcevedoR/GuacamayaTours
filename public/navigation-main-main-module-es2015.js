...
const routes = [
    { path: '', component: src_app_components_main_main_component__WEBPACK_IMPORTED_MODULE_3__["MainComponent"],
        children: [
            { path: 'Home', loadChildren: () => __webpack_require__.e(/*! import() | modules-home-home-module */ "modules-home-home-module").then(__webpack_require__.bind(null, /*! ../../modules/home/home.module */ "./src/app/modules/home/home.module.ts"))
                    .then(m => m.HomeModule) },
            { path: '', redirectTo: 'Home', pathMatch: 'full' },
            { path: 'Hoteles', loadChildren: () => Promise.all(/*! import() | modules-hoteles-hoteles-module */[__webpack_require__.e("default~modules-hoteles-hoteles-module~navigation-admin-admin-module"), __webpack_require__.e("modules-hoteles-hoteles-module")]).then(__webpack_require__.bind(null, /*! ../../modules/hoteles/hoteles.module */ "./src/app/modules/hoteles/hoteles.module.ts"))
                    .then(m => m.HotelesModule) },
            { path: 'Destinos', loadChildren: () => __webpack_require__.e(/*! import() | modules-destinos-destinos-module */ "modules-destinos-destinos-module").then(__webpack_require__.bind(null, /*! ../../modules/destinos/destinos.module */ "./src/app/modules/destinos/destinos.module.ts"))
                    .then(m => m.DestinosModule) },
            { path: 'PlaneaTuViaje', loadChildren: () => __webpack_require__.e(/*! import() | modules-ptv-ptv-module */ "modules-ptv-ptv-module").then(__webpack_require__.bind(null, /*! ../../modules/ptv/ptv.module */ "./src/app/modules/ptv/ptv.module.ts"))
                    .then(m => m.PTVModule) },
            { path: 'Itinerario', loadChildren: () => __webpack_require__.e(/*! import() | modules-itinerario-itinerario-module */ "modules-itinerario-itinerario-module").then(__webpack_require__.bind(null, /*! ../../modules/itinerario/itinerario.module */ "./src/app/modules/itinerario/itinerario.module.ts"))
